...
Despliegue en subdominio de Vercel; dominio propio pendiente. Git inicializado en main, sin primer commit por identidad de autor no configurada. La publicación actual se hizo por CLI, sin integración con un repositorio remoto ni despliegues automáticos por commit.
