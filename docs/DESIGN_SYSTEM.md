...
Portada fotográfica de ancho completo con veladura borgoña para mantener contraste y gran titular. Una franja blanca desliza Investigación, Estructura, Diseño, Tecnología y Datos continuamente, sin control de pausa visible. Con movimiento reducido queda estática y desplazable manualmente. Separación generosa antes de la sección de servicios.
...
Dirección vigente: escenas editoriales creadas mediante la herramienta integrada de generación de imágenes. Se usan en portada, siete capacidades y proceso, con una paleta común de borgoña, piedra cálida, marfil y sombras oscuras. El objetivo es mostrar acciones concretas en lugar de una oficina corporativa genérica. Ninguna escena representa al equipo, oficinas, clientes, proyectos, indicadores o resultados reales de ESCALA. Aprobación final o sustitución por material propio pendiente.
Archivos finales en public/images/brand-series/; WebP optimizados localmente con Pillow, calidad 84, ancho máximo de 1800px en portada y 1536px en servicios. El conjunto de nueve imágenes ocupa aproximadamente 1 MB. Next Image sirve tamaños responsive, precarga la portada y difiere el resto. Las fuentes PNG de generación no forman parte del repositorio; los WebP finales sí.
...
Cambio de fotografía: entrada de 300ms y zoom ligero al pasar el cursor. La foto de portada deriva lentamente; las cinco disciplinas se desplazan continuamente dentro de una banda blanca. Entrada sutil del mensaje principal; hover de controles: 220ms con ligera elevación. El recorrido de servicios requiere activación del visitante. Sin video pesado ni parallax.
