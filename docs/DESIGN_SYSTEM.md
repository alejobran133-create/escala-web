...
Portada de ancho completo con fondo borgoña sobrio y espacio negativo. A la derecha, el símbolo blanco oficial se presenta a menor escala y casi de frente, con un relieve contenido sobre una base baja. Se quitaron las órbitas, nodos, haces de luz y la nota lateral tras el rechazo del usuario a la versión recargada. El PNG original no se redibujó; unas pocas capas CSS crean la profundidad y un giro apenas perceptible. Una veladura protege la lectura del titular. En móvil el símbolo se muestra antes del texto sin ocuparlo todo; a 320 px se reduce para mantener la acción principal al alcance. La franja blanca desliza Investigación, Estructura, Diseño, Tecnología y Datos continuamente, sin control de pausa visible. Con movimiento reducido el símbolo y la franja quedan estáticos, y esta última es desplazable manualmente. Separación generosa antes de la sección de servicios.
...
Cambio de fotografía en servicios: entrada de 300ms y zoom ligero al pasar el cursor. En la portada el símbolo completa una vuelta automática perceptible cada 10 segundos; la luz y la sombra acompañan el giro. El movimiento continúa al pasar el cursor, que añade inclinación interactiva; clic, toque o Enter/Espacio provocan una vuelta adicional. La banda blanca de disciplinas se mueve de forma continua. Entrada sutil del mensaje principal; hover de controles: 220ms con ligera elevación. El recorrido de servicios requiere activación del visitante. Sin descarga de video ni parallax.
