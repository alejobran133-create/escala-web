...
## Implementación
- Ruta /: cabecera, portada fotográfica amplia, explorador de siete servicios, proceso desplegable y cierre de contacto.
...
Por petición del usuario se usa Georgia en todo el texto funcional y Fineday únicamente en acentos de titulares. No se usa Arial/Helvetica en la interfaz. La portada tiene un movimiento fotográfico suave y una franja blanca donde ruedan continuamente las cinco disciplinas, sin botón de pausa; la preferencia de movimiento reducido detiene la animación. En servicios, el usuario puede iniciar y pausar un recorrido temporizado a 3,4 segundos por capacidad, con progreso segmentado; la selección manual toma el control inmediatamente. No se añadió video ni se afirma mostrar proyectos reales. El proceso usa una escena de ruta visual y el cierre tiene una composición editorial ampliada.
