...
## Implementación
- Ruta /: cabecera, portada sobria con el símbolo oficial en relieve contenido sobre una base baja, explorador de siete servicios, proceso desplegable y cierre de contacto.
